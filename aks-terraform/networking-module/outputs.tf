output "vnet_id" {
  description = "The ID of the Virtual Network (VNet) created by the networking module."
...
output "aks_nsg_id" {
  description = "The ID of the Network Security Group (NSG) created by the networking module."
